...
// 1. Using a for-lopp, iterate through this array and console.log all of the people.
for (let i = 0; i < people.length; i++) {
  console.log(people[i]);
}
// Using forEach(), iterate through this array and console.log all of the people.
...
console.log(copy);
// 9. Redefine the people variable with the value you started with. using the splice command, remove "Devon" from the array and add "Elizabeth" and "Artie". Your array should look like this when you are done ["Matt", "Mary", "Elizabeth", "Artie", "Meilyan"].
